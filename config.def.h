...
static const char *colorname[] = {
	...
	"#abb2bf", /* foreground colour    */
	"#1e2228", /* background colour (with transparency looks more like onedark) */
};

unsigned int defaultfg = 256; /* fg */
unsigned int defaultbg = 257; /* bg */
...
wchar_t *worddelimiters = L" "; /* word-delimiter */
...
/* ///// Unchanged Settings ///// 
 * Mostly there to be left as defaults and / or fallback */
